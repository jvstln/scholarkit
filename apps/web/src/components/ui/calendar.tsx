...
const Dropdown = ({
  ...
  return (
    <Select value={value?.toString()} onValueChange={handleChange}>
      <SelectTrigger className="grow outline-none focus:ring-0 focus:ring-offset-0">
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative m-0.5 aspect-square h-full w-full select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
